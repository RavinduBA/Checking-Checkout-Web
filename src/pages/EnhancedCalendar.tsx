...
export default function EnhancedCalendar() {
	...
	const calculateBookingSpan = (booking: any, calendarDays: Date[]) => {
		...
		const startIndex = calendarDays.findIndex((day) =>
			isSameDay(startOfDay(day), checkIn),
		);
		if (startIndex === -1)
			...
			<div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-center">
				<div>
					...
					<p className="text-sm text-muted-foreground">
						Visual booking calendar with room timeline
					</p>
				</div>
						...
						>
							...
							<div className="grid grid-cols-[150px_1fr] border-b bg-gray-50">
								...
								<div
									...
									style={{
										gridTemplateColumns: `repeat(${calendarDays.length}, ${isMobile ? "50px" : "minmax(40px, 1fr)"})`,
									}}
								>
									...
									>
										...
										<div className="p-1 sm:p-2 border-r">
											<div className="flex flex-col sm:gap-1">
												...
												<Badge
													variant="outline"
													className="text-xs sm:mt-1 w-fit"
												>
													{location?.name}
												</Badge>
											</div>
												...
												return calendarDays.map((day, dayIndex) => {
													...
													const isOccupied = roomBookings.some(
														(booking) =>
															...
															dayIndex <
																booking.span.startIndex + booking.span.spanDays,
													);
														...
														>
															{bookingStartingToday && (
																<div
																	...
																	onClick={() =>
																		handleBookingClick(bookingStartingToday)
																	}
														...
														{(reservation.status === "tentative" ||
															...
															<Button
																...
																onClick={(e) => {
																	e.stopPropagation();
																	navigate(
																		`/payments/new?reservation=${reservation.id}`,
																	);
																}}
