  ...
  const handleComplete = async () => {
    try {
      ...
      toast({
        ...
        description: "Your account has been set up successfully. Welcome to HotelVilla Pro!",
      });
        ...
        return (
          <div className="text-center space-y-6">
            ...
            <p className="text-lg text-muted-foreground max-w-md mx-auto">
              Welcome to HotelVilla Pro! Your account has been configured based on your preferences.
            </p>
