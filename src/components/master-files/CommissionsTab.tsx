      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              <Label htmlFor="default_guide_commission">Default Commission Rate (%)</Label>
              <Input
            ...
            <div>
              <Label htmlFor="max_guide_commission">Maximum Commission Rate (%)</Label>
              <Input
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              <Label htmlFor="default_agent_commission">Default Commission Rate (%)</Label>
              <Input
            ...
            <div>
              <Label htmlFor="max_agent_commission">Maximum Commission Rate (%)</Label>
              <Input
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4 text-sm text-muted-foreground">
              <div>
                <h4 className="font-medium text-foreground mb-2">Guide Commissions:</h4>
              ...
              <div>
                <h4 className="font-medium text-foreground mb-2">Agent Commissions:</h4>
                <ul className="list-disc list-inside space-y-1">
                  <li>Calculated based on the room rate portion only</li>
                  <li>Paid monthly after reconciliation</li>
                  <li>Additional services may have different commission rates</li>
                </ul>
              </div>
            </div>
          </CardContent>
