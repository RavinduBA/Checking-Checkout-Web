...
export function ReservationEditDialog({ reservation, isOpen, onClose, onUpdate }: ReservationEditDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Edit Reservation - {reservation.reservation_number}</DialogTitle>
        </DialogHeader>
              ...
              <Select
                ...
                onValueChange={(value) => {
                  ...
                  setFormData({
                    ...
                    total_amount: (selectedRoom?.base_price || formData.room_rate || 0) * (formData.nights || 1)
                  });
                }}
              >
                <SelectTrigger>
          ...
          <div className="bg-muted p-4 rounded-lg">
            <div className="grid grid-cols-3 gap-4 text-sm">
              <div>
                ...
                <div className="text-lg">{formData.currency} {formData.total_amount}</div>
              </div>
              <div>
                <span className="font-medium">Paid Amount:</span>
                <div className="text-lg">{formData.currency} {formData.paid_amount || 0}</div>
              </div>
              <div>
                <span className="font-medium">Balance:</span>
                <div className="text-lg">{formData.currency} {(formData.total_amount || 0) - (formData.paid_amount || 0)}</div>
              </div>
            </div>
          </div>
