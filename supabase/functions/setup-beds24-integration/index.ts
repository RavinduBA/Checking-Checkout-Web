...
serve(async (req) => {
  ...
  try {
    ...
    const inviteCode = 'PFZoMRihKaS5LU/OczUdaxbAtPbnHny1fzfCaCB/1CVcZdEhot67JrJuAdKs7ZPZpwBhTV2Pr6rG8E4agQt5wap2qDXnMVvSBkibyiMAHsI8N9/Ixkaj8bGzUJ2DjuqOF/HAb5A81RHl7IRRNOv/kuORmjr+xg4OEvJWH06pOUY=';
    ...
    return new Response(
      JSON.stringify({
        ...
        data: {
          ...
          tokenPreview: tokenData.token ? `${tokenData.token.substring(0, 20)}...` : 'No token received',
